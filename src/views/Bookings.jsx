...
export default function Bookings() {
  ...
  // Delete Booking
  const handleDeleteBooking = async (bookingId, studentName, date) => {
    if (window.confirm(`Are you sure you want to delete the booking for ${studentName} on ${date}?`)) {
  ...
  if (sortConfig.key !== null) {
    sortedBookings.sort((a, b) => {
      ...
      if (sortConfig.key === 'studentName') {
        ...
        aVal = `${a.date}T${a.timeFrom || '00:00'}`;
        bVal = `${b.date}T${b.timeFrom || '00:00'}`;
                      ...
                      <div style={{ display: 'flex', gap: '0.4rem' }}>
                        ...
                        {b.status !== 'cancelled' ? (
                          <button 
                            ...
                            onClick={() => handleCancelBooking(b.id, b.studentName, b.date)}
